...
namespace Magicianred.StagingArea.Domain.Interfaces.Repositories
{
    ...
    public interface IRegistryEntityRepository
    {
        ...
        /// <param name="cancelToken">cancel token</param>
        IRegistryApplication Insert(IRegistryEntity item, CancellationToken cancelToken = default);
        ...
        /// <param name="cancelToken">cancel token</param>
        IRegistryApplication UpdateById(long id, IRegistryEntity item, CancellationToken cancelToken = default);
